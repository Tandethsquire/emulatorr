...
#' em$get_exp(matrix(c(0.1, 0.1), nrow = 1)) #> 0.6
#' em$get_cov(matrix(c(0.1, 0.1), nrow = 1)) #> 9.5
#' # 4x4 grid of points
...
#' all_specs_em$get_exp(matrix(c(0.1, 0.1), nrow = 1)) #> 0.6
#' all_specs_em$get_cov(matrix(c(0.1, 0.1), nrow = 1)) #> 11.60844
#'
