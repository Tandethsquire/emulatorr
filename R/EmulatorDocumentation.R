...
#'
#' @description Creates an emulator object.
#'
...
#' @name Emulator
#'
#' @section Constructor: \code{Emulator$new(funcs = NULL, beta = NULL, u = NULL, betaucov = NULL)}
#'
...
#'   \code{get_cov} \tab Emulator variance betweeen points \code{x} and \code{xp}. \tab \cr
...
# Emulator Definition
# -------------------
# Somehow this breaks the package. But it doesn't with the Correlator!
# Emulator <- R6::R6Class("Emulator", lock_objects = F)
