...
The results from these can be used in the `generate_new_runs` function. This takes a set of emulators, and finds a new set of points that:
...
```{r}
new_runs <- generate_new_runs(trained_emulators, ranges, input_names, n_points = 10, n_runs = 5, z)
```
